...
**Live:** [https://relaxed-weasel-anonaddy.cloud.nexlayer.ai](https://relaxed-weasel-anonaddy.cloud.nexlayer.ai)  
...
**anonaddy** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    - 80
    vars:
      APP_KEY: "base64:RANDOMKEYHERE+X/rnM7BZZFP+D7TFg="
      DB_HOST: mysql.pod
